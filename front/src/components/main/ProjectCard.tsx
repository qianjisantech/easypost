  ...
  const dropdownContent = (
    <div style={styles.dropdownMenu}>
      ...
      >
        ...
        />
        <span
          style={hoveredItem === 'modify' ? hoverStyles.dropdownText : {}}
        >
          修改项目
        </span>
      </div>
      ...
      >
        ...
        />
        <span
          style={hoveredItem === 'copy' ? hoverStyles.dropdownText : {}}
        >
          复制项目
        </span>
      </div>
      ...
      >
        ...
        />
        <span
          style={hoveredItem === 'delete' ? hoverStyles.dropdownText : {}}
        >
          删除项目
        </span>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Form.Item name="id" hidden initialValue={card.id}>
            <Input type="hidden" />
          </Form.Item>
