...
function ProjectContent() {
  ...
  return (
      <PanelLayout
          ...
          left={
            <>
              <Button type="default" onClick={() => returnToProject('/main')}>首页</Button>
              <Flex gap={token.paddingXXS} style={{ padding: token.paddingXS }}>
                ...
                >
                  ...
                  <Dropdown
                      menu={{
                        items: [
                          ...[MenuItemType.ApiDetail, MenuItemType.HttpRequest, MenuItemType.Doc, MenuItemType.ApiSchema].map((t) => {
